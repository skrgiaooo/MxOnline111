...
class Course(BaseModel):
    ...
    degree = models.CharField(verbose_name='课程难度',max_length=6,choices=DEGREE_CHOICES)
    ...
    cetegory = models.CharField(verbose_name='课程类',max_length=20,default='后端开发')
    ...
    is_banner = models.BooleanField(default=False,verbose_name='广告位')
